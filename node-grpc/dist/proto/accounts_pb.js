...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.accounts.AllAccountsResponse.toObject = function (includeInstance, msg) {
        var f, obj = {
            accountsList: jspb.Message.toObjectList(msg.getAccountsList(), proto.accounts.Account.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.accounts.AllAccountsResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.accounts.Account.serializeBinaryToWriter);
    }
};
/**
...
proto.accounts.AllAccountsResponse.prototype.getAccountsList = function () {
    return /** @type{!Array<!proto.accounts.Account>} */ (jspb.Message.getRepeatedWrapperField(this, proto.accounts.Account, 1));
};
...
proto.accounts.GetAccountResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.accounts.Account.serializeBinaryToWriter);
    }
};
/**
...
proto.accounts.GetAccountResponse.prototype.getAccount = function () {
    return /** @type{?proto.accounts.Account} */ (jspb.Message.getWrapperField(this, proto.accounts.Account, 1));
};
...
//# sourceMappingURL=accounts_pb.js.map